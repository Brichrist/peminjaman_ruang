                                    ...
                                    <div class="border {{ $isBooked ? 'bg-red-50 border-red-300' : 'bg-green-50 border-green-300' }} rounded-lg p-3">
                                        ...
                                        @if($isBooked)
                                            ...
                                            @if($booking->user->whatsapp)
                                                @php
                                                    $waMessage = "Shalom saya {$userName}, permisi saya mau berbicara mengenai peminjaman ruang {$roomName} di jam {$slot} - {$nextSlot}.";
                                                ...
                                                <a href="https://wa.me/{{ $waNumber }}?text={{ $waMessage }}"
                                                   target="_blank"
                                                   class="inline-flex items-center mt-2 bg-green-500 text-white px-2 py-1 rounded text-xs hover:bg-green-600">
